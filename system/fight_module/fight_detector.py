...
class FightDetector:
    ...
    def __init__(self, fight_model):
        ...
        # Set up detection thresholds with defaults if env vars not set
        self.threshold = float(os.getenv("THRESHOLD", "0.5"))
        self.conclusion_threshold = float(os.getenv("CONCLUSION_THRESHOLD", "0.1"))
        self.final_threshold = float(os.getenv("FINAL_THRESHOLD", "1.0"))

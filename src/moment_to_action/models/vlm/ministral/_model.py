"""Ministral-3B Instruct GGUF vision-language model."""
...
class MinistralVLModel(LlamaVLModel):
    """Ministral-3B Instruct GGUF vision-language model served via llama-server.

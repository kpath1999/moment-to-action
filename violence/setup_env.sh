...
echo "  ./run_violence_detection.sh --mode full --dataset /Volumes/KAUSAR/kaggle/Real\\ Life\\ Violence\\ Dataset --test-dirs /Volumes/KAUSAR/rwf2000/RWF-2000/train /Volumes/KAUSAR/rwf2000/RWF-2000/val --analyze"
echo ""

...
class TestPlatformDetection:
    ...
    def _stub_init(platform_instance: Platform) -> None:
        ...
        platform_instance._resource_monitor = MagicMock()
        platform_instance._backends = {ComputeUnit.CPU: MagicMock()}
...
class TestPlatformInitMethods:
    ...
    def test_try_add_htp_backend_logs_warning_when_unavailable(self) -> None:
        ...
        try:
            ...
            assert ComputeUnit.NPU not in p._backends
        finally:
            if saved is None:
    ...
    def test_try_add_qcs6490_gpu_backend_logs_warning_when_unavailable(self) -> None:
        ...
        try:
            ...
            assert ComputeUnit.GPU not in p._backends
        finally:
            if saved is None:
